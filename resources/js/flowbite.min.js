    ...
    return function() {
        ...
        var t = {
            ...
            853: function(t, e, i) {
                    ...
                    fn: function(t) {
                        ...
                        Object.keys(e.elements).forEach((function(t) {
                            var i = e.styles[t] || {}
                              , n = e.attributes[t] || {}
                              , o = e.elements[t];
                            T(o) && O(o) && (Object.assign(o.style, i),
                    ...
                    effect: function(t) {
                        ...
                        function() {
                            Object.keys(e.elements).forEach((function(t) {
                                ...
                                T(n) && O(n) && (Object.assign(n.style, r),
                ...
                function V(t, e, i) {
                    ...
                    var n = t.getBoundingClientRect()
                      , o = 1
                      , r = 1;
                    e && T(t) && (o = t.offsetWidth > 0 && z(n.width) / t.offsetWidth || 1,
                ...
                var Q = {
                    ...
                    phase: "main",
                    fn: function(t) {
                        var e, i = t.state, a = t.name, l = t.options, d = i.elements.arrow, u = i.modifiersData.popperOffsets, p = j(i.placement), h = Y(p), f = [s, r].indexOf(p) >= 0 ? "height" : "width";
                        if (d && u) {
                            var v = function(t, e) {
                ...
                function et(t) {
                    ...
                    if (f) {
                        var O = X(i)
                          , C = "clientHeight"
                          , T = "clientWidth";
                        if (O === x(i) && "static" !== W(O = K(i)).position && "absolute" === p && (C = "scrollHeight",
                        T = "scrollWidth"),
                        c === n || (c === s || c === r) && l === d)
                            k = o,
                            b -= (g && O === A && A.visualViewport ? A.visualViewport.height : O[C]) - a.height,
                            b *= h ? 1 : -1;
                        if (c === s || (c === n || c === o) && l === d)
                            I = r,
                            m -= (g && O === A && A.visualViewport ? A.visualViewport.width : O[T]) - a.width,
                            m *= h ? 1 : -1
                    }
                    var P, H = Object.assign({
                        position: p
                    }, f && tt), j = !0 === v ? function(t) {
                        var e = t.x
                          , i = t.y
                    ...
                    return m = j.x,
                    b = j.y,
                    h ? Object.assign({}, H, ((P = {})[k] = L ? "0" : "",
                    P[I] = w ? "0" : "",
                    P.transform = (A.devicePixelRatio || 1) <= 1 ? "translate(" + m + "px, " + b + "px)" : "translate3d(" + m + "px, " + b + "px, 0)",
                    P)) : Object.assign({}, H, ((e = {})[k] = L ? b + "px" : "",
                    e[I] = w ? m + "px" : "",
                    e.transform = "",
                    e))
                }
                ...
                function vt(t, e, i) {
                    return e === p ? ft(function(t, e) {
                        ...
                        var e, i = K(t), n = lt(t), o = null == (e = t.ownerDocument) ? void 0 : e.body, r = D(i.scrollWidth, i.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), s = D(i.scrollHeight, i.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), a = -n.scrollLeft + dt(t), c = -n.scrollTop;
                ...
                function _t(t) {
                    var e, i = t.reference, a = t.element, c = t.placement, u = c ? j(c) : null, p = c ? Z(c) : null, h = i.x + i.width / 2 - a.width / 2, f = i.y + i.height / 2 - a.height / 2;
                    switch (u) {
                    case n:
                        e = {
                            x: h,
                ...
                var kt = {
                    ...
                    fn: function(t) {
                        ...
                        if (O) {
                            if (d) {
                                var M, q = "y" === k ? n : s, V = "y" === k ? o : r, R = "y" === k ? "height" : "width", W = O[k], F = W + E[q], K = W - E[V], N = m ? -C[R] / 2 : 0, U = L === l ? x[R] : C[R], $ = L === l ? -C[R] : -x[R], J = e.elements.arrow, Q = m && J ? B(J) : {
                                    width: 0,
                                    height: 0
                                    ...
                                    bottom: 0,
                                    left: 0
                                }, et = tt[q], it = tt[V], nt = G(0, x[R], Q[R]), ot = I ? x[R] / 2 - N - nt - et - P.mainAxis : U - nt - et - P.mainAxis, rt = I ? -x[R] / 2 + N + nt + it + P.mainAxis : $ + nt + it + P.mainAxis, st = e.elements.arrow && X(e.elements.arrow), at = st ? "y" === k ? st.clientTop || 0 : st.clientLeft || 0 : 0, ct = null != (M = null == H ? void 0 : H[k]) ? M : 0, lt = W + rt - ct, dt = G(m ? S(F, W + ot - ct - at) : F, W, m ? D(K, lt) : K);
                                O[k] = dt,
                                z[k] = dt - W
                            }
                            if (p) {
                                var ut, pt = "x" === k ? n : s, ht = "x" === k ? o : r, ft = O[A], vt = "y" === A ? "height" : "width", gt = ft + E[pt], _t = ft - E[ht], yt = -1 !== [n, s].indexOf(w), bt = null != (ut = null == H ? void 0 : H[A]) ? ut : 0, Et = yt ? gt : ft - x[vt] - C[vt] - bt + P.altAxis, wt = yt ? ft + x[vt] + C[vt] - bt - P.altAxis : _t, Lt = m && yt ? function(t, e, i) {
                                    var n = G(t, e, i);
                                    return n > i ? i : n
            ...
            902: function(t, e, i) {
                ...
                e.initAccordions = c,
                "undefined" != typeof window && (window.Accordion = a,
            ...
            33: function(t, e, i) {
                ...
                e.initCarousels = c,
                "undefined" != typeof window && (window.Carousel = a,
            ...
            922: function(t, e, i) {
                ...
                e.initCollapses = c,
                "undefined" != typeof window && (window.Collapse = a,
            ...
            556: function(t, e, i) {
                ...
                e.initDials = c,
                "undefined" != typeof window && (window.Dial = a,
                window.initDials = c),
                e.default = a
            },
            791: function(t, e, i) {
                ...
                e.initDismisses = c,
                "undefined" != typeof window && (window.Dismiss = a,
                window.initDismisses = c),
                e.default = a
            },
            340: function(t, e, i) {
                var n = this && this.__assign || function() {
                ...
                e.initDrawers = c,
                "undefined" != typeof window && (window.Drawer = a,
                window.initDrawers = c),
                e.default = a
            },
            316: function(t, e, i) {
                var n = this && this.__assign || function() {
                ...
                e.initDropdowns = d,
                "undefined" != typeof window && (window.Dropdown = l,
                window.initDropdowns = d),
                e.default = l
            },
            311: function(t, e, i) {
                Object.defineProperty(e, "__esModule", {
            ...
            656: function(t, e, i) {
                ...
                "undefined" != typeof window && (window.InputCounter = a,
            ...
            16: function(t, e, i) {
                ...
                e.initModals = c,
                "undefined" != typeof window && (window.Modal = a,
                window.initModals = c),
                e.default = a
            },
            903: function(t, e, i) {
                ...
                e.initPopovers = d,
                "undefined" != typeof window && (window.Popover = l,
                window.initPopovers = d),
                e.default = l
            },
            247: function(t, e, i) {
                var n = this && this.__assign || function() {
                ...
                e.initTabs = c,
                "undefined" != typeof window && (window.Tabs = a,
                window.initTabs = c),
                e.default = a
            },
            671: function(t, e, i) {
                ...
                e.initTooltips = d,
                "undefined" != typeof window && (window.Tooltip = l,
                window.initTooltips = d),
                e.default = l
            },
            947: function(t, e) {
                Object.defineProperty(e, "__esModule", {
