            ...
            return function(s) {
                return function(t) {
                    ...
                    for (; d; )
                        try {
                            if (i = 1,
                            n && (m = 2 & t[0] ? n.return : t[0] ? n.throw || ((m = n.return) && m.call(n),
                            0) : n.next) && !(m = m.call(n, t[1])).done)
                                return m;
                            switch (n = 0,
                            m && (t = [2 & t[0], m.value]),
                            t[0]) {
                            ...
                            default:
                                if (!(m = d.trys,
                                (m = m.length > 0 && m[m.length - 1]) || 6 !== t[0] && 2 !== t[0])) {
                                    d = 0;
                                    continue
                                }
