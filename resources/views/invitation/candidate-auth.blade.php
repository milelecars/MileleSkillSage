<div>
    <form action="{{ route('invitation.validate', ['invitationLink' => $invitation_token]) }}" method="POST">
        {{-- <form method="POST" action="{{ route('invitation.validate', ['invitationLink' => last(explode('/', $invitation->link))]) }}" class="w-full max-w-sm mx-auto my-2"> --}}
