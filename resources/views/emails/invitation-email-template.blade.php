...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <p>You have been selected to complete the <strong>"{{ $testName }}"</strong> assessment as part of our evaluation process for the role of <strong>"{{ $role }}"</strong> at Milele {{ $department }} . This test will assist us in evaluating your skills and determining your potential fit within our organization.</p>
        ...
        <ul>
            ...
            <li>For smoother experience, take the test from a desktop/laptop.</li>
