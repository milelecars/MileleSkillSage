            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                <div class="p-8">
                    ...
                    @if(Auth::guard('candidate')->check())
                        ...
                        <p class="text-lg mt-8 text-gray-700">By proceeding, you agree to these terms and conditions. <strong>Good luck!</strong></p>
                        
                        <div class="flex justify-end mt-8">
                            <a href="{{ route('test.start', $test->id) }}" class="inline-flex items-center px-6 py-3 bg-blue-600 border border-transparent rounded-md font-semibold text-white uppercase tracking-widest hover:bg-blue-500 active:bg-blue-700 focus:outline-none focus:border-blue-700 focus:ring focus:ring-blue-300 disabled:opacity-25 transition">
                                Start Test
