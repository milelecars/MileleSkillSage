                ...
                <div class="p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-6">
                            ...
                            @if($hasLSQ && !empty($categoryScores))
                                        ...
                                        @foreach($categoryScores as $category => $data)
                                            <div>
                                                <div class="flex justify-between mb-1">
                                                    ...
                                                    <span class="text-sm font-semibold">{{ $data['average'] }}/5</span>
                                                </div>
                                                <div class="w-full bg-gray-200 rounded-full h-2.5">
                                                    <div class="bg-indigo-500 h-2.5 rounded-full" style="width: {{ ($data['average'] / 5) * 100 }}%"></div>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
