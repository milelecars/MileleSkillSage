<x-app-layout>
    <div class="py-12 text-theme" id="dashboard-container">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 gap-4 mx-4">
                ...
                {{-- right --}}
                <div>
                    <div id="camera-warning" class="flex items-center gap-5 bg-warning p-5 mb-4 overflow-hidden shadow-sm rounded-lg">
                        ...
                        <div class="mb-6">
                            ...
                            @else
                                ...
                                <div class="flex justify-between items-center bg-gray-100 border-l-4 border-gray-500 rounded-lg p-4 mb-4">
                                    ...
                                    class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700"
                                    id="view-guidelines-btn" style="display: none;">
                                        View Guidelines
                                    </a>
                                </div>
                            @endif
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Function to update button visibility based on webcam status
            function updateButtonVisibility(personCount, hasBook, hasCellPhone) {
                if (personCount === 1 && !hasBook && !hasCellPhone) {
                    viewGuidelinesBtn.style.display = 'inline-flex';
                    cameraWarning.style.display = 'none';
                } else {
                    viewGuidelinesBtn.style.display = 'none';
                    if (personCount === 0) {
            ...
            // Add event listener for webcam status updates
