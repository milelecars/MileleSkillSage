...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                     <?php $__env->slot('trigger', null, []); ?> 
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-9 w-9 fill-white">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                ...
                <?php elseif(Auth::guard('candidate')->check()): ?>
                    ...
                    <div class="font-medium text-sm text-gray-500"><?php echo e(Auth::guard('candidate')->user()->email); ?></div>
                <?php endif; ?>
            </div>
...
<?php /**PATH /Users/heliahaghighi/Desktop/Projects/AGCT-Software/resources/views/layouts/navigation.blade.php ENDPATH**/ ?>