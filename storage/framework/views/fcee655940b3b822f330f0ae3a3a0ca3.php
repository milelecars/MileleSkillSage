            ...
            <form action="<?php echo e(route('tests.store')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-3 gap-6 bg-white shadow-md rounded-lg p-8">
                    ...
                    <div class="mr-4">
                        ...
                        <input type="number" name="duration" id="duration" required class="appearance-none border rounded-lg w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Enter the duration" value="<?php echo e(old('duration')); ?>">
                    </div>
