            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <a href="<?php echo e(route('manage-candidates')); ?>" class="block p-6 bg-green-100 hover:bg-green-200 rounded-lg transition duration-300">
...
<?php endif; ?><?php /**PATH /Users/heliahaghighi/Desktop/Projects/AGCT-Software/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>