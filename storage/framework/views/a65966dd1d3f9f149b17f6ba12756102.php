    ...
    <div class="test-section">
        <div class="test-sec-header">
            ...
            <div class="data">
                <div class="test-sec-data">
                    ...
                    <p class="score-detail-value"><?php echo e($averageScore); ?>%</p>
                </div>
                <div class="test-sec-data">
                    <p class="score-detail">Weighted</p>
                    <p class="score-detail-value"><?php echo e($weightedScore); ?>%</p>
                </div>
            </div>
        </div>
        ...
        <div class="test">
            <table class="test-header-table">
                <tr>
                    <td class="test-title"><?php echo e($test['name']); ?></td>
                    <td class="test-score"><?php echo e($test['score']); ?>%</td>
                </tr>
            </table>
    
            <div class="test-description"><?php echo e($test['description']); ?></div>
            ...
            <div class="skill-item">
                ...
                <table class="skill-bar-table">
                    <tr>
                        <?php if($skill['correct'] > 0): ?>
                        <td class="bar-correct" width="<?php echo e($skill['correct']*25); ?>%">
                            <?php echo e($skill['correct']); ?>

                        </td>
                        <?php endif; ?>
                        <?php if($skill['incorrect'] > 0): ?>
                        <td class="bar-incorrect" width="<?php echo e($skill['incorrect']*25); ?>%">
                            <?php echo e($skill['incorrect']); ?>

                        </td>
                        <?php endif; ?>
                        <?php if($skill['unanswered'] > 0): ?>
                        <td class="bar-unanswered" width="<?php echo e($skill['unanswered']*25); ?>%">
                            <?php echo e($skill['unanswered']); ?>
            ...
            <div class="time-info">
                Finished in <?php echo e($test['time_spent']); ?> out of <?php echo e($test['time_limit']); ?>
...
</html><?php /**PATH /Users/heliahaghighi/Desktop/Projects/AGCT-Software/resources/views/reports/candidate-report.blade.php ENDPATH**/ ?>