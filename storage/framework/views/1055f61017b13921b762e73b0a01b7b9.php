                            ...
                            <div class="flex gap-2 justify-between items-center w-[40%]">
                                ...
                                <form method="GET" action="<?php echo e(route('tests.index')); ?>" class="flex gap-2">
                                    ...
                                    <input
                                        ...
                                        class="w-44 sm:w-64 h-9 border text-xs md:text-sm border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                                    />
                                ...
                                <div class="relative" x-data="{ open: false }">
                                    ...
                                    <div x-show="open" 
                                        ...
                                        style="display: none;">
                                        <div class="py-1">
                                            <a href="<?php echo e(route('tests.create')); ?>" class="flex items-center px-4 py-2 text-xs md:text-sm text-gray-700 hover:bg-gray-100">
                                            ...
                                            <a href="<?php echo e(route('tests.archived')); ?>" class="flex items-center px-4 py-2 text-xs md:text-sm text-gray-700 hover:bg-gray-100">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 md:w-5 md:h-5 mr-3 text-gray-500">
                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5M10 11.25h4M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125z" />
                                                </svg>
                                                Archived
                                            </a>
                                            <a href="<?php echo e(route('admin.invite')); ?>" class="flex items-center px-4 py-2 text-[11px] text-xs md:text-sm text-gray-700 hover:bg-gray-100">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 md:w-5 md:h-5 mr-3 text-gray-500">
                                ...
                                <li class="p-5 hover:bg-gray-100 hover:rounded-lg transition duration-150 ease-in-out ">
                                    <div class="flex justify-between items-center">
                                        <a href="<?php echo e(route('tests.show', ['id' => $test->id])); ?>" class="flex-grow">
                                            <h3 class="text-md md:text-xl font-semibold text-blue-700"><?php echo e($test->title); ?></h3>
                                            <p class="text-xs md:text-sm text-gray-600 mt-2 text-justify"><?php echo e(Str::limit($test->description, 100)); ?></p>
                                        </a>
