...
<?php $component->withAttributes([]); ?>
    <?php if(session('error')): ?>
        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-lg relative w-full max-w-sm mx-auto mb-4" role="alert">
    ...
    <?php if(session('success')): ?>
        <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-lg relative w-full max-w-sm mx-auto mb-4" role="alert">
