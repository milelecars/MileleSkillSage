                                    ...
                                    <?php $__currentLoopData = $candidateTests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="text-center">
                                            <td class="px-2 py-4 text-base">
                                                ...
                                                <div class="text-base text-gray-500"><?php echo e($test['questions_count']); ?> questions</div>
                                            </td>
                                            <td class="px-2 py-4 text-base">
                                            ...
                                            <td class="px-2 py-4">
                                                <div class="flex justify-center gap-2">
                                                    <?php if(!in_array($test['status'], ['completed', 'accepted', 'rejected'])): ?>
                                                        <a href="<?php echo e(route('tests.setup', $test['test_id'])); ?>"> 
                                                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/>
                                                            </svg>
                                                        </a>
                                                    <?php else: ?>
                                                        <a href="<?php echo e(route('tests.result', $test['test_id'])); ?>">
                                                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
