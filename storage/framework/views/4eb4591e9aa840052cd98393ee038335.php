<div>
    ...
    <form wire:submit.prevent="addEmail" class="flex gap-2">
        ...
        <button type="submit" 
                class="bg-blue-700 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg inline-flex items-center"
    ...
    <!--[if BLOCK]><![endif]--><?php if($emailList): ?>
        <div class="mt-6">
            <button wire:click="submitInvitations" 
                    ...
                    class="bg-green-700 hover:bg-green-600 text-white font-bold py-2 px-4 rounded-lg inline-flex items-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed">
