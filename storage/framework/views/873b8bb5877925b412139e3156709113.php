...
<script>
    function departmentDropdown() {
        return {
            ...
            newDept: '',
            error: '',
            departments: <?php echo json_encode($departments->pluck('name'), 15, 512) ?>,
            ...
            async addDepartment() {
                ...
                try {
                    const response = await fetch('<?php echo e(route('departments.store')); ?>', {
                        method: 'POST',
                        headers: {
...
<?php /**PATH C:\Users\HeliaHaghighi\Desktop\MileleSkillSage\resources\views/admin/invite.blade.php ENDPATH**/ ?>