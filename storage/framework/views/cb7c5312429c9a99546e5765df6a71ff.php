                ...
                <div class="overflow-x-auto rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200 border border-gray-200 rounded-lg">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 text-center">
                            <?php $__currentLoopData = $admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="px-2 py-4 text-xs md:text-sm">
                                        <form method="POST" action="<?php echo e(route('admin.access-control.update', $admin->id)); ?>">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
                                            <input name="name" type="text" value="<?php echo e($admin->name); ?>" class="border border-gray-300 rounded-md p-1 text-sm w-full" />
                                    </td>
                                    <td class="px-2 py-4 text-xs md:text-sm">
                                            <input name="email" type="email" value="<?php echo e($admin->email); ?>" class="border border-gray-300 rounded-md p-1 text-sm w-full" />
                                    </td>
                                    <td class="px-2 py-4 text-xs md:text-sm">
                                    ...
                                    <td class="px-2 py-4 flex justify-center items-center space-x-2">
                                        ...
                                        <form action="<?php echo e(route('admin.access-control.destroy', $admin->id)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Delete this admin?')">
                                            <?php echo csrf_field(); ?>
                            ...
                            <tr>
                                <form method="POST" action="<?php echo e(route('admin.access-control.store')); ?>" class="grid grid-cols-4 gap-2 md:gap-4">
                                    <?php echo csrf_field(); ?>
                                    <td class="px-2 py-4 text-xs md:text-sm">
...
<?php endif; ?>
<?php /**PATH C:\Users\HeliaHaghighi\Desktop\MileleSkillSage\resources\views/admin/access-control.blade.php ENDPATH**/ ?>