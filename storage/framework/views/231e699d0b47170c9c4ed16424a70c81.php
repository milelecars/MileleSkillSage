                ...
                <div class="p-4 sm:p-6 md:p-8">
                    ...
                    <div class="flex flex-row justify-between items-center gap-4 mb-4">
                        <div class="flex flex-col justify-between">
                            <h1 class="text-lg md:text-2xl font-extrabold text-gray-900"><?php echo e($test->title); ?></h1>
                    ...
                    <div class="mb-10 flex w-full justify-end ">
                        <?php if(Auth::guard('web')->check()): ?>
                            <a href="<?php echo e(route('tests.invite', $test->id)); ?>" class=" inline-flex items-center bg-green-600 hover:bg-green-500 text-white font-semibold px-4 py-3 rounded-md text-xs Sdisabled:opacity-25 transition">
                    ...
                    <?php if(Auth::guard('web')->check() || (Auth::guard('candidate')->check() && ($test->title == "General Mental Ability (GMA)"))): ?>
                                ...
                                <?php if(Auth::guard('web')->check()): ?>
                                    <?php if($questions->count() > 10): ?>
                                        <p class="text-gray-600 italic mt-4 text-xs md:text-base">
                                            Showing 8 out of <?php echo e($questions->count()); ?> questions...
                                        </p>
                                    <?php endif; ?>
                                <?php endif; ?>
