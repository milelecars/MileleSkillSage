            ...
            <form action="<?php echo e(route('tests.store')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-3 gap-6 bg-white shadow-md rounded p-8">
                    <div class="mr-4">
                        ...
                        <input type="text" name="title" id="title" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Enter the test title" value="<?php echo e(old('title')); ?>">
                    </div>
                    <div class="mr-4">
                        <label for="duration" class="block text-gray-700 text-md font-bold mb-2">Duration</label>
                        <input type="text" name="duration" id="duration" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Enter the duration" value="<?php echo e(old('duration')); ?>">
                    </div>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2706364438-0', $__slots ?? [], get_defined_vars());
...
?>
                    ...
                    <div class="col-span-3">
                        ...
                        <textarea name="description" id="description" rows="4" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Enter a description for the test"><?php echo e(old('description')); ?></textarea>
                    </div>
                    <div class="col-span-3">
...
<?php endif; ?><?php /**PATH /Users/heliahaghighi/Desktop/Projects/AGCT-Software/resources/views/tests/create.blade.php ENDPATH**/ ?>