...
<form method="POST" action="<?php echo e(route('login')); ?>" class="w-full max-w-sm mx-auto my-2">
    ...
    <div class="flex items-center justify-center mt-9">
        ...
        <!-- <a href="" class="inline-block align-baseline font-bold text-sm md:text-base text-theme hover:text-blue-600">
            Need an account?
        </a> -->
    </div>
</from><?php /**PATH /Users/heliahaghighi/Desktop/MyFile/Projects/MileleSkillSage/resources/views/livewire/login-field.blade.php ENDPATH**/ ?>