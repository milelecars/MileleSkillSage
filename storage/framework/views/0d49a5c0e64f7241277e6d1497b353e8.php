                ...
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <form method="GET" action="<?php echo e(route('admin.manage-candidates')); ?>" class="flex gap-2">
                            ...
                            <a href="<?php echo e(route('admin.export-candidates', ['search' => $search ?? '', 'test_filter' => $testFilter ?? ''])); ?>" class="px-3 h-9 bg-green-600 text-white text-sm font-semibold rounded-lg hover:bg-green-700 flex items-center gap-1">
