                                ...
                                <li class="p-4 hover:bg-gray-100 transition duration-150 ease-in-out rounded-lg">
                                    <div class="flex justify-between items-center">
                                        ...
                                        <div class="flex space-x-2">
                                            <a href="<?php echo e(route('tests.edit', $test->id)); ?>" class="text-yellow-500 hover:text-yellow-600 p-2 rounded-full hover:bg-yellow-100 transition duration-150 ease-in-out">
...
<?php endif; ?><?php /**PATH /Users/heliahaghighi/Desktop/Projects/AGCT-Software/resources/views/tests/index.blade.php ENDPATH**/ ?>